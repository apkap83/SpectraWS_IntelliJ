 ...
 * 
 */
@WebServiceClient(name = "WebCDRDBService", targetNamespace = "http://web.cdrdb.wind.gr/", wsdlLocation = "http://spectra.wind.gr:8080/CDR_DB_LIVE/WebCDRDBService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://spectra.wind.gr:8080/CDR_DB_LIVE/WebCDRDBService?wsdl");
