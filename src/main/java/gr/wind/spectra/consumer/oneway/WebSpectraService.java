 ...
 *
 */
@WebServiceClient(name = "WebSpectraService", targetNamespace = "http://web.spectra.wind.gr/", wsdlLocation = "http://10.10.18.121:8080/SpectraWS/WebSpectraService?wsdl")
public class WebSpectraService extends Service
{
	...
	static
	{
		...
		try
		{
			url = new URL("http://10.10.18.121:8080/SpectraWS/WebSpectraService?wsdl");
